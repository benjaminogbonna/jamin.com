...
define('DBPASSWORD','');
define('DBNAME', 'cart_DB');

// windows path
//define('BASH_PATH', 'C:/xampp/htdocs/jamin.com/');
// ubuntu path
//define('BASH_PATH', 'var/www/build-shopping-cart-in-codeigniter/');
// MAC path
define('BASH_PATH', '/Applications/XAMPP/htdocs/jamin.com/');
...
define('APPLICATION_NAME', 'JAMINS');
define('APPLICATION_URL', 'JAMINS.COM');
define('SITE_DELIMETER_MSG', 'Best regards,');
define('SITE_DELIMETER', 'Jamins Team');
define('SALT', FALSE);

define('TO_MAIL', 'xxx@xxx.com');
define('FROM_MAIL', 'xxx@xxx.com');
define('FROM_TEXT', 'JAMINS.COM');
